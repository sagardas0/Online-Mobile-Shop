...
import {  handleUpdateProduct } from '@/utils/handleAddNewProduct';
import { generateUniqueID } from '@/utils/UniqueIDGenerator';
import { getAllBrandInfo } from '@/utils/getAllBrandInfo';

const AdminProductUpdate = ({setShow ,product,setShowUpdateSection,fetchAllProducts}) => {
