  ...
  return (
    <div className='flex flex-col items-center justify-center py-10 p-5'>
        ...
        <footer className='text-xs flex items-center justify-center text-center  p-3'>
          ...
          <span>Online Mobile SHOP, All Rights Reserved  </span>
          {/* <div className='pl-3'>
            <Link href={'/admin'} className=' font-bold text-gray-700 hover:text-white rounded-full bg-sky-500/10 hover:bg-sky-800 duration-300 inline-block px-3 py-2'>Admin Panel</Link>
          </div> */}
        </footer>
